...
// Initialisation du client Supabase via l'objet global "window.supabase"
...
async function getWalletTotals() {
  ...
  try {
    ...
    document.getElementById("walletTotals").textContent =
      "Erreur lors du chargement des wallet_totals: " + error.message;
  }
}
...
async function getReferals() {
  ...
  try {
    ...
    document.getElementById("referals").textContent =
      "Erreur lors du chargement des referals: " + error.message;
  }
}
